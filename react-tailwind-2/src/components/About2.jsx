...
const About2 = () => {
    return (
        <Layouts xx="mt-[6.25rem] mb-[100px] flex-between-center flex-col-reverse gap-5 xl:gap-0 xl:flex-row">
            <div>
                <img src="/assets/img/about-2/1.png" alt="" />
            </div>
            <div className="max-w-[36.875rem] text-center xl:text-left">
                <p className="heading-small-2 mb-[1rem] text-center xl:text-left">
                    Overline
                </p>
                ...
                <div className="mb-[3.6875rem] flex justify-center xl:justify-start space-x-[1.5rem]">
                    <div className="w-auto xl:max-w-[12.25rem]">
                ...
                <div className="flex justify-center xl:justify-start space-x-[1rem]">
